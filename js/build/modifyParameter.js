        ...
        var ModifyParameter = React.createClass({displayName: "ModifyParameter",
            ...
            render: function () {
                ...
                if (this.props.dialog) {
                    ...
                    processBar = React.createElement(ProcessBar, {step: "step1"});
                    topBtn=React.createElement("div", null);
                    btnControl = (React.createElement("div", null, 
                        React.createElement("button", {type: "button", className: "btn btn-primary modify-btn-success", 
                                onClick: this.nextClick}, "完成准入", React.createElement("span", {className: "glyphicon glyphicon-menu-right"})
                        ), 
                ...
                switch (this.state.targetDiv) {
                    ...
                    case 'total_overdue_amount_percentage':
                    case 'max_overdue_amount_percentage':
                        rangeSlider = (React.createElement(RangeSlider, {chartIndex: "0", label: '%', 
                                                    max: 100*this.state.barChart.max, 
                                                    min: 100*this.state.barChart.min, 
                                                    now: 100*this.state.rangeValue}));

                        rangeBar = (React.createElement("div", {className: "modify-parameter-middle-chart-ps"}, 
                            "整体平均值 ", 100 * this.state.barChart.average, "% 最大值 ", 100 * this.state.barChart.max, "%"
                        ))
                        break;
                    case 'ave_monthly_sale_amount':
                        rangeSlider = (React.createElement(RangeSlider, {chartIndex: "0", label: '万元', 
                        ...
                        break;
                    default:
                        rangeSlider = (React.createElement(RangeSlider, {chartIndex: "0", 
                ...
                return (
                    React.createElement("div", null, 
                        processBar, 
                        topBtn, 
                        React.createElement("div", {className: "modify-parameter container"}, 
                            React.createElement("div", {className: "title row"}, "准入设置"), 
                            React.createElement("div", {className: "title-ps row"}, "根据经销商贸易相关性，历史还款行为等关键指标设置授信准入标准。"), 
                            React.createElement("div", {className: "row wrap"}, 
                                React.createElement("div", {className: "col-md-3 left"}, 
                                    React.createElement("div", {className: this.chooseClassName('no_deal_day_till_now')}, 
                                        React.createElement("span", {className: "left-title", 
                                              "data-detail": "经销商距数据截止日连续无交易天数的分布", 
                                              "data-ps": "距数据截止日连续x天没有交易不准入", 
                                              "data-condition-name": "no_deal_day_till_now"}, "距数据截止日连续无交易天数"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {
                                            className: "opt"}, this.chooseText('no_deal_day_till_now'), React.createElement("span", {
                                            className: "close-btn"}, "x"))

                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('ave_monthly_sale_amount')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商月均交易金额的分布", 
                                              "data-ps": "月均交易金额低于x万元不准入", 
                                              "data-condition-name": "ave_monthly_sale_amount"}, "月均交易金额"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {
                                            className: "opt"}, this.chooseText('ave_monthly_sale_amount'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('ave_dso')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商平均销售周转天数的分布", 
                                              "data-ps": "平均销售周转天数超过x天不准入", 
                                              "data-condition-name": "ave_dso"}, "平均销售周期"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {
                                            className: "opt"}, this.chooseText('ave_dso'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('ave_overdue_days')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商平均逾期天数的分布", 
                                              "data-ps": "平均逾期天数超过x天，不准入", 
                                              "data-condition-name": "ave_overdue_days"}, "平均逾期天数"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {className: "opt"}, this.chooseText('ave_overdue_days'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('max_overdue_days')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商最大逾期天数的分布", 
                                              "data-ps": "最大逾期天数超过x天，不准入", 
                                              "data-condition-name": "max_overdue_days"}, "最大逾期天数"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {className: "opt"}, this.chooseText('max_overdue_days'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('total_overdue_bill_count_percentage')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商总逾期订单比例的分布", 
                                              "data-ps": "总逾期订单比例大于x%，不准入", 
                                              "data-condition-name": "total_overdue_bill_count_percentage"}, "总逾期订单比例"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {
                                            className: "opt"}, this.chooseText('total_overdue_bill_count_percentage'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('1_3_day_overdue_amount_percentage')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商1-3天逾期订单金额比例的分布", 
                                              "data-ps": "1-3天逾期订单金额占已核销订单金额比例大于x%，不准入", 
                                              "data-condition-name": "1_3_day_overdue_amount_percentage"}, "1-3天逾期订单金额比例"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {
                                            className: "opt"}, this.chooseText('1_3_day_overdue_amount_percentage'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('4_7_day_overdue_amount_percentage')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商4-7天逾期订单金额比例的分布", 
                                              "data-ps": "4-7天逾期订单金额占已核销订单金额比例大于x%，不准入", 
                                              "data-condition-name": "4_7_day_overdue_amount_percentage"}, "4-7天逾期订单金额比例"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {
                                            className: "opt"}, this.chooseText('4_7_day_overdue_amount_percentage'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('7_more_day_overdue_amount_percentage')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商大于7天逾期订单金额比例的分布", 
                                              "data-ps": "大于7天逾期订单金额占已核销订单金额比例大于x%，不准入", 
                                              "data-condition-name": "7_more_day_overdue_amount_percentage"}, "大于7天逾期订单金额比例"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {
                                            className: "opt"}, this.chooseText('7_more_day_overdue_amount_percentage'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('total_overdue_amount_percentage')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商累计逾期金额占总订单金额比例的分布", 
                                              "data-ps": "累计逾期金额占已核销订单金额比例大于x%，不准入", 
                                              "data-condition-name": "total_overdue_amount_percentage"}, "累计逾期金额占订单总金额比例"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {className: "opt"}, this.chooseText('total_overdue_amount_percentage'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    ), 
                                    React.createElement("div", {className: this.chooseClassName('max_overdue_amount_percentage')}, 
                                        React.createElement("span", {className: "left-title", "data-detail": "经销商最大逾期金额占总订单金额比例的分布", 
                                              "data-ps": "最大逾期金额占已核销订单金额比例大于x%，不准入", 
                                              "data-condition-name": "max_overdue_amount_percentage"}, "最大逾期金额占订单总金额比例"), 
                                        React.createElement("br", null), 
                                        React.createElement("span", {className: "opt"}, this.chooseText('max_overdue_amount_percentage'), React.createElement("span", {
                                            className: "close-btn"}, "x"))
                                    )

                                ), 
                                React.createElement("div", {className: "col-md-6 middle"}, 
                                    React.createElement("div", {className: "modify-parameter-middle-chart-tab"}), 
                                    React.createElement("div", {className: "modify-parameter-middle-title"}), 
                                    React.createElement("div", {className: "modify-parameter-middle-chart-title"}, "参考指标"), 
                                    React.createElement("div", {className: "modify-parameter-middle-chart-title-ps"}), 
                                    React.createElement(BarChart, {chartIndex: "2", X: this.state.barChart.bucket_bounday, 
                                              Y: [['经销商个数'].concat(this.state.barChart.dealer_count)], 
                                              isHistogram: "true", height: "230"}), 

                                    rangeBar, 

                                    React.createElement("div", {className: "range-slider-container-title"}, "准入设置"), 
                                    React.createElement("div", {className: "range-slider-container row"}, 
                                        ...
                                        React.createElement("div", {className: "col-md-6"}, 
                                            React.createElement("div", {className: "row", className: "range-slider-container-right"}, 
                                                React.createElement("div", {className: "col-md-6"}, this.state.barChart.admitted_count, React.createElement("br", null), "准入家数"
                                                ), 
                                                React.createElement("div", {
                                                    className: "col-md-6"}, (100 * this.state.barChart.admitted_percentage).toFixed(2), "%", React.createElement("br", null), "准入比例"
                                                )
                                            )
                                        )
                                    )
                                ...
                                React.createElement("div", {className: "col-md-3 right"}, 
                                    React.createElement("div", {className: "right-title"}, "准入结果预览"), 
                                    React.createElement(DonutChart, {chartIndex: "0", title: "准入经销商占比", height: "160", divStyle: {paddingLeft:"60px"}, 
                                    ...
                                    React.createElement(DonutChart, {chartIndex: "1", title: "准入经销商销售额占比", height: "160", 
