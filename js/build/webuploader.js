        ...
        render: function () {
            return (
                React.createElement("div", {id: "uploader", className: "wu-example"}, 
                    React.createElement("div", {className: "uploader-title"}, "将数据文件拖到此处"), 
                    React.createElement("div", {className: "uploader-title-else"}, "或者，您可以"), 
                    React.createElement("div", {className: "btns uploader-btns-container"}, 
                        React.createElement("div", {id: "picker"}, "上传数据文件")
                        /* <button id="ctlBtn" className="btn btn-default">开始上传</button> */
                    ), 
                    React.createElement("div", {className: "uploader-title-else2"}, "支持xls, xlsx文件")
