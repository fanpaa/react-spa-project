        ...
        render: function () {
            ...
            return (
                <div className="range-slider-module">
                    <div className="range-slider-text-head">{head}</div>
                    <div className="range-slider-text">{label}</div>
                    <form id={inputForm}><input type="text" id={inputId} className="form-control"/></form>
                    <div id={indexId}></div>
                </div>
            )
        }
